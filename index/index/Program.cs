...
namespace index
{
    ...
    class A
    {
        ...
        public int this[int index, int made]                    // overlode
        {
            get {
                Console.WriteLine("get이 호출");
                return a * made * index; }
            set { Console.WriteLine("set이 호출"); ; }
        }
        public int this[int index]                              // overlode
        {
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            a[10, 20] = 20;                          //set 호출
            Console.WriteLine($"{a[10, 20]}");       //get 호출
